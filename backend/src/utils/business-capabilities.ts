...
export const CATEGORY_DEFAULT_CAPABILITIES: Record<string, string[]> = {
  ...
  CAFE: ['HERO', 'ABOUT', 'CATALOG', 'PRODUCTS', 'GALLERY', 'PROMOTIONS', 'OPENING_HOURS', 'MAP', 'WHATSAPP', 'CONTACT', 'CONTACT_FORM', 'LEADS', 'CTA', 'FOOTER', 'SEO', 'ANALYTICS'],
  NAILS: ['HERO', 'ABOUT', 'SERVICES', 'PRICING', 'GALLERY', 'PROMOTIONS', 'BOOKING', 'WHATSAPP', 'MAP', 'OPENING_HOURS', 'CONTACT', 'CONTACT_FORM', 'LEADS', 'CTA', 'FOOTER', 'SEO', 'ANALYTICS'],
  FITNESS: ['HERO', 'ABOUT', 'SERVICES', 'PRODUCTS', 'TEAM', 'GALLERY', 'BOOKING', 'TESTIMONIALS', 'WHATSAPP', 'OPENING_HOURS', 'CONTACT', 'CONTACT_FORM', 'LEADS', 'CTA', 'FOOTER', 'SEO', 'ANALYTICS'],
  AUTO: ['HERO', 'ABOUT', 'SERVICES', 'BEFORE_AFTER', 'GALLERY', 'PROMOTIONS', 'BOOKING', 'WHATSAPP', 'MAP', 'OPENING_HOURS', 'CONTACT', 'CONTACT_FORM', 'LEADS', 'CTA', 'FOOTER', 'SEO', 'ANALYTICS'],
  PRO: ['HERO', 'ABOUT', 'SERVICES', 'TEAM', 'PORTFOLIO', 'TESTIMONIALS', 'FAQ', 'BOOKING', 'WHATSAPP', 'MAP', 'CONTACT', 'CONTACT_FORM', 'LEADS', 'CTA', 'FOOTER', 'SEO', 'ANALYTICS'],
};
