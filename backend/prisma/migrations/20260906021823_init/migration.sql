-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CUSTOMER', 'ADMIN', 'SUPPORT', 'AUDITOR');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'FULFILLED', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "FulfillmentProvider" AS ENUM ('DROPSHIP_DEFAULT', 'DSERS', 'ALIEXPRESS_DIRECT');
...
CREATE TABLE "Supplier" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "provider" "FulfillmentProvider" NOT NULL DEFAULT 'DSERS',
    "apiKey" TEXT,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "PriceRule" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "defaultMargin" INTEGER NOT NULL DEFAULT 60,
...
CREATE TABLE "Product" (
    ...
    "profitMargin" INTEGER NOT NULL DEFAULT 60,
    "importSource" TEXT NOT NULL DEFAULT 'DSERS',
    "dserStatus" TEXT NOT NULL DEFAULT 'draft',
